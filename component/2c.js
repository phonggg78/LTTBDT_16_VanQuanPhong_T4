...
export default function Cau2c() {
    ...
    const handleGenerate = () => {
        ...
        if(!(length > 8 && length < 21))
            alert('Invalid length of password, length of pass word: [8-20]')
        else if(!(length > 8 && length < 21) && !isLowerCase && !isNumber && !isUpperCase && !isSpecialSymbol)
            ...
            <View style={styles.wrapper}>
                ...
                <View style={styles.bodyWrapper}>
                    ...
                    <View style={styles.conditionWrapper}>
                        ...
                        <TextInput style={styles.lengthInput} value={length} onChangeText={setLength} ></TextInput>
                    </View>
                    <View style={styles.conditionWrapper}>
                        <Text style={styles.conditionTxt}>Include lowestcase letters</Text>
                ...
                <TouchableOpacity style={styles.btnWrapper} onPress={handleGenerate}>
